...
export type FileFieldsEnum = 
  ...
  | 'childMarkdownRemark___frontmatter___subPath'
...
export type SiteTitleQueryQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'title' | 'author'>> }> };
...
export type Unnamed_3_Query = { allMarkdownRemark: { edges: Array<{ node: (
        ...
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'category' | 'date' | 'subPath'>> }
      ) }> } };

export type LatestPostListQueryQueryVariables = {};


export type LatestPostListQueryQuery = { allMarkdownRemark: { edges: Array<{ node: (
        Pick<MarkdownRemark, 'excerpt' | 'id'>
        & { frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'title' | 'subPath' | 'category' | 'date'>> }
      ) }> } };
